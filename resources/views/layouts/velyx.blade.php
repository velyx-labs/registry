            ...
            <nav class="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                    ...
                    <div class="flex h-14 items-center justify-between">
                        ...
                        @auth
                            <div class="hidden md:flex items-center space-x-6">
                                <a href="{{ route('dashboard') }}" class="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">
                                    Dashboard
                                </a>
                                <a href="/components" class="text-sm font-medium text-muted-foreground transition-colors hover:text-foreground">
                                    Components
                                </a>
                ...
                >
                    <div class="px-6 py-3 space-y-3">
                        @auth
                            <a href="{{ route('dashboard') }}" class="block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted">
                                Dashboard
                            </a>
                        @endauth
                        <a href="/docs" class="block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted">
                            Documentation
                        </a>
                        <a href="/components" class="block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted">
                            Components
                        </a>
                        @guest
                            <a href="{{ route('login') }}" class="block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted">
                                Log in
                            </a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="block px-3 py-2 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted">
                                    Sign up
                                </a>
                            @endif
                        @endguest
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <ul class="space-y-3">
                                ...
                                <li>
                                    <a href="/components" class="text-sm text-muted-foreground hover:text-foreground transition-colors">
                                        Components
                                    </a>
                                </li>
                                <li>
                        ...
                        <div class="space-y-4">
                            ...
                            <ul class="space-y-3">
                                ...
                                <li>
                                    <a href="/support" class="text-sm text-muted-foreground hover:text-foreground transition-colors">
                                        Support
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="mt-8 pt-8 border-t border-border">
                        <div class="flex flex-col md:flex-row justify-between items-center">
                            ...
                            <div class="flex space-x-6 mt-4 md:mt-0">
                                <a href="https://github.com/velyx/velyx" class="text-muted-foreground hover:text-foreground transition-colors">
                                    <x-lucide-github class="w-5 h-5" />
                                </a>
                                <a href="https://twitter.com/velyx" class="text-muted-foreground hover:text-foreground transition-colors">
