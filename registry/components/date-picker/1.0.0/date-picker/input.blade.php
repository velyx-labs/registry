...
<div class="relative" data-slot="date-picker-input">
    ...
    <input
        ...
        readonly
        @disabled($disabled)
        class="border-input bg-background text-foreground cursor-pointer placeholder:text-muted-foreground focus:ring-ring focus:ring-offset-background w-full rounded-lg border pr-10 pl-10 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 {{ $sizeClasses }}"
    />
